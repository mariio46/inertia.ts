...
import { RolePermissionAssignment } from '@/types/assignments-data';
import { Link, useForm } from '@inertiajs/react';
import { useState } from 'react';

export function PermissionOption({ role }: { role: RolePermissionAssignment }) {
    const [openAlertDialog, setOpenAlertDialog] = useState<boolean>(false);
    const { delete: destroy, processing } = useForm();
    function deleteRole(role: RolePermissionAssignment) {
        destroy(route('assignments.permissions.delete', [role]), {
            preserveScroll: true,
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align='end' className='w-56'>
                ...
                <DropdownMenuItem asChild>
                    <Link href={route('assignments.permissions.edit', [role])}>
